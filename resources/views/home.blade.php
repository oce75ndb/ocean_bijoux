        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            ...
            @if ($produitA)
                <div class="bg-white shadow-md rounded-lg p-4 border border-gold">
                    <img src="{{ asset('images/' . $produitA->image) }}" alt="{{ $produitA->nom }}" class="w-full h-48 object-cover rounded">
            ...
            @if ($produitB)
                <div class="bg-white shadow-md rounded-lg p-4 border border-gold">
                    <img src="{{ asset('images/' . $produitB->image) }}" alt="{{ $produitB->nom }}" class="w-full h-48 object-cover rounded">
            ...
            @if ($produitC)
                <div class="bg-white shadow-md rounded-lg p-4 border border-gold">
                    <img src="{{ asset('images/' . $produitC->image) }}" alt="{{ $produitC->nom }}" class="w-full h-48 object-cover rounded">
